...
VALUES 
    ("u001", "beltrano", "beltrano@email.com", "beltrano2001", DATE('now')),
	("u002", "fulana", "fulana@email.com", "fulana2001", DATE('now')),
	("u003", "ciclano", "ciclano@email.com", "ciclano99", DATE('now'));
...
VALUES 
    ("pu001", 20, 1, DATE('now'),"u001"),
    ("pu002", 2999, 0, DATE('now'),"u001"),
    ("pu003", 98, 0, DATE('now'),"u002"),
    ("pu004", 45, 0, DATE('now'),"u003");
